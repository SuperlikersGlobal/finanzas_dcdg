...
import { renderViajes } from './ui/viajes.js';
...
import { renderCierre } from './ui/cierre.js';
...
import { renderPresupuesto } from './ui/presupuesto.js';
...
function go(s) {
  ...
  if (s === 'presupuesto') renderPresupuesto();
